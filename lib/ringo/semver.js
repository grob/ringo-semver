...
var isEqual = exports.isEqual = function(versionA, versionB) {
    return compare(versionA, versionB, "isEqual");
};

var isGreater = exports.isGreater = function(versionA, versionB) {
    return compare(versionA, versionB, "isGreater");
};

var isGreaterOrEqual = exports.isGreaterOrEqual = function(versionA, versionB) {
    return compare(versionA, versionB, "isGreaterOrEqual");
};

var isLower = exports.isLower = function(versionA, versionB) {
    return compare(versionA, versionB, "isLower");
};

var isLowerOrEqual = exports.isLowerOrEqual = function(versionA, versionB) {
...
var parseVersion = exports.parseVersion = function(version) {
...
var parseRange = exports.parseRange = function(range) {
...
var sanitizeRange = exports.sanitizeRange = function(range) {
...
var sanitizeVersion = exports.sanitizeVersion = function(version) {
    var [M, m, p, tag] = parseVersion(version);
...
var getSorter = exports.getSorter = function(order) {
    return function(a, b) {
 ...
 * @type Boolean
 */
exports.isCompatible = function(versionA, versionB) {
    var [majorA] = parseVersion(versionA);
    var [majorB] = parseVersion(versionB);
